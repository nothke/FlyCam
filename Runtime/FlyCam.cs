...
namespace Nothke.FlyCamera
{
    public class FlyCam : MonoBehaviour
    {
        ...
        public bool useNumpadArrows = false;
        ...
        void DoMouseLook()
        {
            ...
            tpos.y = Mathf.Clamp(tpos.y, 1, 10000);
            tpos.x = Mathf.Clamp(tpos.x, -1000, 1000);
            tpos.z = Mathf.Clamp(tpos.z, -1000, 1000);
